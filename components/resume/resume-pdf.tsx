...
const styles = StyleSheet.create({
  ...
  entryPeriod: { fontFamily: "Courier", fontSize: 7.5, color: C.body },
  entryLocation: { fontFamily: "Courier", fontSize: 7, color: C.faint, marginTop: 2 },
  ...
  eduPeriod: { fontFamily: "Courier", fontSize: 7, color: C.muted, marginTop: 2 },
